...
<table  id="customers">
  <tr>
    <td><h1>AmanKhalsa</h1></td>
    <td><h2>Khalsa School ERP</h2>
    <p>School Address</p>
    <p>School Phone</p>
    <p>School Email </p>
...
<table id="customers">
  <tr>
    ...
    <tr>
    <td></td>
    <td><b>Student Profile  </b></td>
    <td><img src="{{(!empty($details['student']['image'])) ? url('upload/student_image/'.$details['student']['image']): url('upload/no_image.jpg')}}" width="100" height="100"></td>
  </tr>
  <tr>
    <td>1</td>
