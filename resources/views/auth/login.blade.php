...
<head>
  <meta charset="utf-8">
    ...
    <title>Khalsa Admin - Log in </title>
...
<div class="form-group">
    <div class="input-group mb-3">
        ...
        <input type="email" id="email"  class="form-control pl-15 bg-transparent text-white plc-white" name="email" placeholder="Useremail">
    </div>
</div>
<div class="form-group">
    <div class="input-group mb-3">
    ...
    <!-- /.col -->
                            ...
                            <div class="text-center">
                                <p class="mt-15 mb-0 text-white">Don't have an account? 
                                    <a href="{{route('register')}}" class="text-white ml-5">Sign Up</a></p>
                            </div>
                        </div>
                    </div>
                </div>
